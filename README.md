<p align="center">
  <img src="./docs/banner.svg" alt="turbovec_lite_rs banner" width="100%" />
</p>
...
**Recall** — real sentence embeddings (`all-MiniLM-L6-v2`, 384-dim), 800 sentences, vs. exact search:
...
**Compression** — 100K vectors, 384-dim, full serialized index:

| | Size |
|---|---|
| Raw float32 | 153.6 MB |
| Packed 2-bit | 12.2 MB |
| **Ratio** | **12.6x** |
